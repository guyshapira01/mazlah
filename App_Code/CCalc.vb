        ...
        ElseIf TypeOf objNode Is clsOperator Then
            Select Case objNode.operator
                ...
                Case "^"
                    Return GetResult(objNode.Left) ^ GetResult(objNode.Right)
                Case "@"
                    Return CInt(GetResult(objNode.Left) / GetResult(objNode.Right))
                Case "%"
                    Return GetResult(objNode.Left) Mod GetResult(objNode.Right)
