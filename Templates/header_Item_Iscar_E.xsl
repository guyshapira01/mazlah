...
<xsl:template match="/">
	...
	<body class="BodyCatalog" background="background.gif">
...
function Prop(){
	...
	<table cellpadding="0" cellspacing="0" border="1" bordercolor="Blue" dir="rtl">
		<tr>
			...
			<td width="100">
				<!--Logo Should Come Here-->
				<img src="IscarLogo.gif" height="32"/>
			</td>
		</tr>
	</table>
	</div>
	...
	<table class="TableMainBarDOC" border="0" >
			<tr align="center" >
				...
				<td>
					<nobr>
					<!--
					<a href="javascript:;"><IMG src="back.jpg" alt = "Previous Page" onclick="javascript:parent.history.back();"></a>
					<a href="javascript:;"><IMG src="forward.jpg" align="absbottom" alt ="Next Page" onclick="javascript:parent.history.forward();"></a>
					-->
					<xsl:choose>
