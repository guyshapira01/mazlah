	...
	<table class="TableMainBar" border="0" >
			<tr align="center" >
				...
				<td>
					...
					<a href="javascript:;"><IMG src="forward.jpg" align="absbottom" alt ="Next" onclick="javascript:parent.history.forward();"></a>
					-->
					<a><xsl:attribute name="href"><xsl:value-of select="Header/Prev" /></xsl:attribute><IMG src="next.jpg" alt = "Prev" /></a>
					<a><xsl:attribute name="href"><xsl:value-of select="Header/Next" /></xsl:attribute><IMG src="prev.jpg" alt = "Next" /></a>
					</nobr>
			...
			<xsl:choose>
				...
				<td>
					...
					<a href="javascript:;" style="cursor:hand;" onclick="javascript:SetColRatio('30%,0%,70%');"><b><IMG src="image_index.jpg" alt = "Image And Index" /></b></a>
					<a href="javascript:;" style="cursor:hand;" onclick="javascript:SetColRatio('20%,45%,40%');"><b><IMG src="image_table_index.jpg" alt ="Image, Table And Index" /></b></a>
