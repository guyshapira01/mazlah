	...
	<table class="TableMainBar" border="0" >
			<tr align="center" >
				...
				<td>
					...
					<a href="javascript:;" style="cursor:hand;" onclick="javascript:SetColRatio('70%,0%,30%');"><b><IMG src="image_index.jpg" alt = "אינדקס ואיור" /></b></a>
					...
					<a style="cursor:hand; position:relative ; top : -2.5;" onclick="javascript:SaveColRatio_3frames();" target="_blank" id="pritim_link_top"><b><IMG src="freeze.jpg" alt = "הקפאה" /></b></a>
					</nobr>
				</td>
				<td>
