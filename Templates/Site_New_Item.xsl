...
<!-- End Validation -->
	...
	<input type="hidden">
		<xsl:attribute name="value">layout0</xsl:attribute>
...
<tr align="center">
<td>
<img border="0" align="absmiddle" src="images/NewDocument.gif" width="35"></img>&#160;&#160;<font color="9b0000" style="FONT-SIZE:24px">New Site Item</font>
<hr/>
...
<TR>
 ...
 <TR>
	...
	<TD class="tabletext" align="left">
			<input type="text">
				<xsl:attribute name="value">SiteLayout1.html</xsl:attribute>
	...
	function checkType()
			{
				...
				if (curType=='71')
					NewObject.PPARTTEMPLATE.value='SiteNewsLayout.html';
				if (curType=='68')
					NewObject.PPARTTEMPLATE.value='SiteEventsLayout.html';
			}
	</script>
  ...
  <TR>
	<TD bgcolor="#eef7de" class="TableHeader" ><b>Direction:</b></TD>
			<TD class="TableText" align="left">
				...
				<OPTION value="ltr">
					<xsl:choose>
						<xsl:when test="ltr=//NewDataSet/Catalogs/PPROP10">
							<xsl:attribute name="selected">True</xsl:attribute>
						</xsl:when>
					</xsl:choose>
					Left</OPTION>
				<OPTION value="rtl">
					<xsl:choose>
						<xsl:when test="rtl=//NewDataSet/Catalogs/PPROP10">
							<xsl:attribute name="selected">True</xsl:attribute>
						</xsl:when>
					</xsl:choose>
				Right</OPTION>
