...
<BODY class="BodyIndex" onunload="" background="background.gif">
	...
	<xsl:when test="$RootIndexParam='True'">
		<table  border="0"  cellspacing="0" >
			<tr  valign="top" >  
				...
				<td class="ToolBarGlow_BG" onmouseover="glow(true, this);" onmouseout="glow(false, this);">
					<a>
						...
						<img align="absmiddle" src="WEImages/collapse.gif" alt="Collapse All" id="CollapseLable"></img>
						&#160;Collapse All
					</a>
				</td>
				<td>&#160;&#160;</td>
				<td class="ToolBarGlow_BG" onmouseover="glow(true, this);" onmouseout="glow(false, this);">
					<a>
						...
						<img src="WEImages/Expand.jpg" align="absmiddle" alt="Expand All" id="ExpandLable"></img>
						&#160;Expand All
					</a>
				</td>			
		...
		<!--	<td ><input type="hidden" id="Expand" name="IndexStatus" value="0" ></input></td>
					<td>
						<img src="Collaps_Unpressed.jpg" alt="Collapse All" id="CollapseLable">
							<xsl:attribute name="onclick">JavaScript:collapseAll(0);</xsl:attribute>
							<xsl:attribute name="onMouseOver">this.style.cursor='hand';
							</xsl:attribute>
							<xsl:attribute name="onMouseOut">this.style.cursor='normal';
							</xsl:attribute>
					...
					<td>&#160;&#160;</td>
						...
						<td>
							<img src="Expand.jpg" alt="Expand All" id="ExpandLable">
								<xsl:attribute name="onclick">JavaScript:expandALL(0);</xsl:attribute>
								<xsl:attribute name="onMouseOver">this.style.cursor='hand';
								</xsl:attribute>
								<xsl:attribute name="onMouseOut">this.style.cursor='normal';
								</xsl:attribute>
	...
	<TR>
				<td  bgcolor="#d2ccb9" width="50"> 
					<table border="2" cellspacing="2" cellpadding="2">
						<tr>
							<td nowrap="yes">
								<a class="LW-font" href="JavaScript:AddObj('New_Item_Folder_Doc_E.xsl');void(0);" target="_self" title="New">
									<img src="WEImages/newfolder.gif" alt="New" border="0" width="16" height="16"/>
									New Folder
								</a>
							</td>
					<!--	<td class="LW-toolbar" nowrap="yes">
								<a class="LW-font" href="JavaScript:AddObj('New_Item_Folder_Doc_E.xsl');void(0);" target="_self" title="New"> New Folder</a>
							</td>
					-->
						</tr>
					</table>
		...
		<xsl:when test="Level = 1">
			...
			<xsl:choose>
				<xsl:when test="Object/Level &gt; 1">
					...
					<xsl:choose>
						<xsl:when test="$ObjectClassParam = 'Chapter'"><img align="absMiddle" src="FolderClose_E.gif" onmouseover="enter();" onmouseout="leave();"><xsl:attribute name="name"><xsl:value-of select="$IDParam" /></xsl:attribute><xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');</xsl:attribute></img></xsl:when>
						<xsl:when test="$ObjectClassParam = 'Page'"><img align="absMiddle" src="page_pic.gif" onmouseover="enter();" onmouseout="leave();"><xsl:attribute name="name"><xsl:value-of select="$IDParam" /></xsl:attribute><xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');</xsl:attribute></img></xsl:when>
						...
						<xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');</xsl:attribute>
						</img>
					...
					<xsl:choose>
						<xsl:when test="$ObjectClassParam = 'Chapter'">
							<span class="level1" ><xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');</xsl:attribute><xsl:value-of select="$NameParam" /></span>
			     			</xsl:when>
				...
				<xsl:otherwise>
					<div  style="  right=20;">
<img src="spacer.gif" width="12" height="11"/>
...
<div><xsl:attribute name="style">position:relative; cursor:hand;left:<xsl:value-of select="number(Level)*20"/></xsl:attribute>					
				...
				<xsl:attribute name="name"><xsl:value-of select="$IDParam" /></xsl:attribute>
				<xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');						</xsl:attribute></img></xsl:when>
				...
				<img src="IconTypes/Close.gif" align="absMiddle">
				<xsl:attribute name="name"><xsl:value-of select="$IDParam" /></xsl:attribute>
				<xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>','<xsl:value-of select="ParentKey"/>');</xsl:attribute></img>
				<img width = "16" height = "16" align="absMiddle"><xsl:attribute name="src">IconTypes/<xsl:value-of select="Type"/>.gif</xsl:attribute></img>
				</xsl:when>
				</xsl:choose>
<xsl:choose>
						<xsl:when test="$ObjectClassParam = 'Chapter'">
							<span class="level2" ><xsl:attribute name="onclick">Switch('inner_<xsl:value-of select="$IDParam" />','<xsl:value-of select="$IDParam" />','IconTypes/Close.gif','IconTypes/Open.gif','<xsl:value-of select="number(Level)"/>','<xsl:value-of select="//TreeIndex/CatalogKey"/>');</xsl:attribute><xsl:value-of select="$NameParam" /></span>
						</xsl:when>
						<xsl:when test="$ObjectClassParam = 'Item'">
