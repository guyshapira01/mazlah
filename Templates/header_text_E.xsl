	...
	<table class="TableMainBar" border="0" >
			<tr align="center" >
				...
				<td>
					<nobr>
					<!--
					<a href="javascript:;"><IMG src="back.jpg" alt = "Prev" onclick="javascript:parent.history.back();"></a>
				...
				<td>
					...
					<a style="cursor:hand; position:relative ; top : -2.5;" onclick="javascript:SaveColRatio_IndexText();" target="_blank" id="pritim_link_top"><b><IMG src="freeze.jpg" alt = "Freeze Frames" /></b></a>
					</nobr>
				</td>
				<td>
					<div id="scontentmain">
