					...
					<TD align="left" vAlign="top" width="100%">
						<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="2" height="100%" width="100%">
							<TR>
								...
								<TD nowrap="yes">
									<font style="color:black;font-size:14px">&#160;&#160;Severity:</font>
								</TD>
								<TD nowrap="yes"  colspan="1" align="left" vAlign="top" bgcolor="d2ccb9">
										 &#160;<font style="color:blue;font-size:16px"><xsl:value-of select="Items/Item/PPROP74"/></font>
								</TD>
							</TR>
							<TR>
								<TD nowrap="yes">
											...
											<TD>
												<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="5" align="center" dir="ltr" width="100%">
													...
													<TR>
														...
														<TD>Subsystem:</TD>
														<TD align="left" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop40"> <xsl:value-of /></xsl:for-each></font>
														</TD>
													...
													<TR>
														<TD colspan="1">In which site the failure occurred:</TD>
													...
													<TR>
														...
														<TD align="left" colspan="1" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="PPROP75"> <xsl:value-of /></xsl:for-each></font>
														</TD>

													</TR>
													<TR>
														<TD colspan="1">Conditions when the failure occurred:</TD>
														<TD align="left" colspan="1" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="PPROP49"> <xsl:value-of /></xsl:for-each></font>
														</TD>
														<TD colspan="1">Test Step:</TD>
														<TD align="left" colspan="1" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="PPROP79"> <xsl:value-of /></xsl:for-each></font>
														</TD>

													</TR>
													<TR>
														<TD colspan="1">Environmental conditions:</TD>
														<TD align="left" colspan="1" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop1"> <xsl:value-of /></xsl:for-each></font>

															<xsl:for-each select="Prop1Files">
																<a target="_blank" >
																<xsl:attribute name="href">
																	<xsl:value-of />
																</xsl:attribute>
																<img src="document.gif" border="0" alt="Open Attached File"/>
																</a>

															</xsl:for-each>
														</TD>
														<TD colspan="1">Meter Reading:</TD>
														<TD align="left" colspan="1" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="PPROP76"> <xsl:value-of /></xsl:for-each></font>
															&#160;<font style="color:darkblue;font-size:17px"><xsl:for-each select="PPROP85"> <xsl:value-of /></xsl:for-each></font>
														</TD>

													</TR>
													<TR>
														<TD colspan="1">Operational conditions:</TD>
														<TD align="left" colspan="3" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop2"> <xsl:value-of /></xsl:for-each></font>
														</TD>
													</TR>
													<TR>
														<TD colspan="1">Description of the failure:</TD>
														<TD align="left" colspan="3" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop3"> <xsl:value-of /></xsl:for-each></font>
														</TD>
													</TR>
										...
										<TR>
											<TD>
												<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="0" align="center" dir="ltr" width="100%">
													...
													<TR>
														<TD align="left" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:12px"><xsl:for-each select="Prop4"> <xsl:value-of /></xsl:for-each></font>
														</TD>
														<TD align="left" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:12px"><xsl:for-each select="Prop5"> <xsl:value-of /></xsl:for-each></font>
														</TD>
														<TD align="left" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:12px"><xsl:for-each select="Prop6"> <xsl:value-of /></xsl:for-each></font>
														</TD>
														<TD align="left" class="NotesTabs_gray">&#160;
															<font style="color:darkblue;font-size:12px"><xsl:for-each select="Prop8"> <xsl:value-of /></xsl:for-each></font>
														</TD>
													</TR>
															...
															<TD>
																<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="5" align="center" dir="ltr" width="100%">
																	<TR>
																		...
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop9"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
																	<TR>
																		<TD><font style="font-size:12px">Repair of Demaged Items:</font></TD>
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop11"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
																</TABLE>
															</TD>
															...
															<TD>
																<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="5" align="center" dir="ltr" width="100%">
																	...
																	<TR>
																		...
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop15"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
															...
															<TD>
																<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="5" align="center" dir="ltr" width="100%">
																	<TR>
																		...
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop12"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
																	<TR>
																		<TD><font style="font-size:12px">Verify Effectiveness  of Corrective Action:</font></TD>
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop34"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
																	<TR>
															...
															<TD>
																<TABLE class="BorderNoBackground" border="0" cellPadding="0" cellSpacing="5" align="center" dir="ltr" width="100%">
																	...
																	<TR>
																		...
																		<TD align="left" class="NotesTabs_gray">&#160;
																			<font style="color:darkblue;font-size:17px"><xsl:for-each select="Prop27"> <xsl:value-of /></xsl:for-each></font>
																		</TD>
																	</TR>
		...
		-->			
						...
						<td  bgcolor="#d2ccb9" width="50"> 
							<table border="2" cellspacing="2" cellpadding="2">
								<tr>
									<td nowrap="yes">
											<a class="LW-toolbar" href="JavaScript:UpdateObj('T_CAT_PART','Update_Failure_TAAS_E.xsl','true');void(0);" target="_self" title="Edit">
						...
						<td  bgcolor="#d2ccb9" width="50"> 
							<table border="2" cellspacing="2" cellpadding="2">
								<tr>
									<td nowrap="yes">
										<a target="_self" class="LW-toolbar" href="JavaScript:printPage('Center_Failure_Print.xsl','TSGa6615');void(0);" title="Print">
								...
								<tr>
									<td nowrap="yes">
										<a class="LW-toolbar" title="FAR Data">
											<xsl:attribute name="href">
												JavaScript:w=window.open('../generatereport.aspx?Catalog=TSGa6615&amp;Table=T_CAT_PART&amp;XSL=Center_Failure_FAR.xsl&amp;PKEY=<xsl:value-of select="Items/Item/ID"/>','FailureReport','width=750,height=710,toolbar=no,scrollbars=yes');w.focus();void(0);
											</xsl:attribute>	
