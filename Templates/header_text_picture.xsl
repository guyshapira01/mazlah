	...
	<table class="TableMainBar" border="0" >
			<tr align="center" >
				...
				<td>
					...
					<a style="cursor:hand; position:relative ; top : -2.5;" onclick="javascript:SaveColRatio_IndexPicture();" target="_blank" id="pritim_link_top"><b><IMG src="freeze.jpg" alt = "הקפאה" /></b></a>
					</nobr>
				</td>
				<td>
