	...
	<table cellpadding="0" cellspacing="0" border="0" bordercolor="Blue" dir="rtl" width="100%">
			<tr>
				<td>
	  			...
	  			<td align="left" dir="ltr"><b style="color:black;font-size:80%">Folder Name: </b><xsl:value-of select="Header/PageHebDesc" /></td>
	  			<td align="left" dir="ltr"><b style="color:black; font-size:80%">Project: </b><xsl:value-of select="Header/CatalogName" /></td>
				<td>
				</td>
			</tr>
	</table>
	...
	<table class="TableMainBarDOC" border="0" >
			<tr align="center" >
				<td>
					...
					<IMG src="home.jpg" alt="Back To Home" align="absmiddle"/>
					<SCRIPT LANGUAGE="javascript">
						//Add the correct href acording to the url - local or internet
						//CheckSearchURL();
					</SCRIPT>
					<a href="http://200.200.39.87/LinkwareDocSearch" target="_blank"><IMG border="0" src="search.jpg" alt = "Search" /></a>
				...
				<td>
					...
					<!-- <a href="javascript:;" style="cursor:hand;" onclick="javascript:SetColRatio('0%,*,0%');"><b><IMG src="table.jpg" alt = "Table" /></b></a> -->
					...
					<!-- <a href="javascript:;" style="cursor:hand;" onclick="javascript:SetColRatio('40%,45%,20%');"><b><IMG src="image_table_index.jpg" alt ="Image, Table And Index" /></b></a> -->
					<a style="cursor:hand; position:relative ; top : -2.5;" onclick="javascript:SaveColRatio_DocumentsIndex();" target="_blank" id="pritim_link_top"><b><IMG src="freeze.jpg" alt = "Freeze Frames" /></b></a>
					</nobr>
				</td>
				<td>
					<div id="scontentmain">
