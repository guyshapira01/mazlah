<%@ Page Language="vb" AutoEventWireup="false" CodeFile="CatalogList.aspx.vb" Inherits="CatalogList"%>
    ...
    <div class="catalog-topbar">
      <div class="catalog-brand">
        ...
        <div>
          ...
          <div class="catalog-brand-title"><asp:Label ID="lblCDName" runat="server"></asp:Label></div>
        </div>
      </div>
      <div class="catalog-top-hint">בחר קטלוג לצפייה</div>
    </div>

    <div class="catalog-toolbar">
      <div class="catalog-toolbar-actions">
        <a class="catalog-btn favorite" href="FavoritesCatalogs.aspx" target="_self">
          <img src="images/catalog-ui/star.png" alt="" />
          קטלוגים מועדפים
        </a>
